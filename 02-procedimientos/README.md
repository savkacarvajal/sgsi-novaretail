...
> Cada procedimiento tiene su **diagrama de flujo (BPMN)** en [`../03-evidencias/diagramas/procedimientos/`](../03-evidencias/diagramas/procedimientos/) (PNG + fuente SVG; índice Mermaid en `DIAGRAMAS-PROCEDIMIENTOS.md`).
